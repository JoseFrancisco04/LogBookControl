...
- **🗺️ Mapa del Laboratorio:** Visualización interactiva del laboratorio para conocer el estado y distribución de los equipos.
...
npm run dev
```
El proyecto estará disponible en `http://localhost:5173`. ¡Ábrelo en tu navegador y disfruta!
